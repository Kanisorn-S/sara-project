...
\begin{figure}[h]
  ...
  \begin{tikzpicture}
    ...
    \begin{scope}[x={(img.south east)}, y={(img.north west)}]
      ...
      \draw[red, line width=5pt, rounded corners] (0.7,0.45) rectangle (0.6,0.58);
      \node[red, fill=white, font=\small, align=center] at (0.75,0.80) {Thermistor and adjacent fixed resistor};

      % Optional arrows
      \draw[->, line width=2pt, red] (0.75,0.77) -- (0.7,0.58);
    \end{scope}
  \end{tikzpicture}
